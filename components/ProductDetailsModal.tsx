        ...
        <div className="w-full md:w-1/2 p-8 overflow-y-auto">
          <div className="mb-6">
            <div className="flex gap-2 mb-2">
               <span className="bg-blue-100 text-tech-blue text-[10px] uppercase font-bold px-2 py-1 rounded">
                {laptop.condition}
              </span>
          ...
          <button 
            ...
            className="w-full bg-tech-blue text-white py-4 rounded-2xl font-black flex items-center justify-center gap-3 shadow-lg hover:bg-blue-900 transition active:scale-[0.98]"
          >
