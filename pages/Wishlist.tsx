...
const Wishlist: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12 min-h-[60vh]">
      <Helmet>
        <title>My Wishlist | Info-Fix Laptop Nigeria</title>
        <meta name="description" content="Your saved laptops. Keep track of the best deals at Info-Fix Laptop Nigeria." />
      </Helmet>
      ...
      {wishlist.length > 0 ? (
        ...
        <div className="bg-white p-20 rounded-3xl text-center border-2 border-dashed border-gray-200 max-w-2xl mx-auto">
          ...
          <Link to="/shop" className="bg-tech-blue text-white px-10 py-4 rounded-2xl font-black inline-flex items-center gap-2 hover:bg-blue-900 transition shadow-xl">
            <ShoppingBag size={20} />
            Browse Laptops
          </Link>
        </div>
