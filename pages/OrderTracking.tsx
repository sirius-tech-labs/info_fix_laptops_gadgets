        ...
        <div className="max-w-3xl mx-auto px-4 py-12 min-h-[70vh]">
            ...
            <form onSubmit={(e) => { e.preventDefault(); handleSearch(); }} className="flex gap-3 mb-8">
                ...
                <button
                    ...
                    className="bg-tech-blue text-white px-8 py-4 rounded-2xl font-black hover:bg-blue-900 transition active:scale-95 shadow-lg disabled:opacity-50"
                >
                    {isSearching ? '...' : 'Track'}
                </button>
            </form>
                    ...
                    <div className="space-y-3">
                        {recentOrders.map(order => (
                            <button
                                ...
                                className="w-full flex items-center gap-4 bg-white p-4 rounded-2xl border border-gray-100 hover:border-tech-blue hover:shadow-md transition-all text-left group"
                            >
                                <div className="bg-blue-50 p-3 rounded-xl text-tech-blue flex-shrink-0 group-hover:bg-tech-blue group-hover:text-white transition-colors">
                                    <Package size={20} />
                                </div>
                                ...
                                <div className="flex items-center gap-2 flex-shrink-0">
                                    <span className="text-tech-blue font-black text-sm hidden sm:block">{formatPrice(order.totalAmount)}</span>
                                    <ChevronRight size={18} className="text-gray-300 group-hover:text-tech-blue transition-colors" />
                                </div>
                            </button>
                        ))}
                    </div>
            ...
            {searched && !foundOrder && (
                <div className="bg-white p-12 rounded-3xl shadow-sm border border-gray-100 text-center">
                    ...
                    <button
                        ...
                        className="mt-6 text-tech-blue font-bold text-sm underline"
                    >
            ...
            {foundOrder && (
                <div className="space-y-8">
                    ...
                    <button
                        ...
                        className="text-tech-blue font-bold text-sm flex items-center gap-1 hover:underline"
                    >
                                ...
                                <div className="pt-2 space-y-2">
                                    {foundOrder.items.map((item: any, i: number) => (
                                        <div key={i} className="flex items-center gap-3 bg-gray-50 p-3 rounded-xl">
                                            ...
                                            <span className="text-xs font-black text-tech-blue">{formatPrice(item.price * (item.quantity || 1))}</span>
                                        </div>
                                    ))}
                                </div>
                            )}
