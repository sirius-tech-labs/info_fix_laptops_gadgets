  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-24">
        <div>
          <h2 className="text-3xl font-black text-gray-900 mb-12 text-center italic">Why Choose Giant edge technology for Bulk Supply?</h2>
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              <div className="bg-orange-100 p-3 rounded-2xl text-orange-600 h-fit"><PackageCheck size={24} /></div>
              <div>
        ...
        <div className="bg-white p-8 md:p-12 rounded-3xl shadow-2xl border border-gray-100">
          ...
          <form className="space-y-4">
            ...
            <button className="w-full bg-tech-blue text-white py-4 rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-blue-900 transition">
      ...
      <div className="bg-tech-blue text-white rounded-3xl p-10 md:p-20 text-center relative overflow-hidden">
        <div className="relative z-10">
          <h2 className="text-3xl md:text-5xl font-black mb-6 italic underline decoration-blue-400">Safely Delivered Anywhere in Nigeria</h2>
