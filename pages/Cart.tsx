    ...
    return (
      <div className="max-w-7xl mx-auto px-4 py-20 text-center">
        <div className="bg-white p-12 rounded-3xl shadow-sm border border-gray-100 max-w-md mx-auto">
          ...
          <Link to="/shop" className="bg-tech-blue text-white px-8 py-4 rounded-xl font-bold inline-block hover:bg-blue-900 transition">
            Start Shopping
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12">
      <div className="flex items-center gap-2 mb-8">
        <Link to="/shop" className="text-tech-blue hover:underline flex items-center gap-1 font-bold">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <div className="lg:col-span-1 space-y-6">
            ...
            <div key={item.id} className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 flex gap-4 items-center">
              ...
              <div className="flex-grow">
                ...
                <div className="flex items-center justify-between mt-2">
                  ...
                  <p className="text-sm font-black text-tech-blue">{formatPrice(item.price * item.quantity)}</p>
                </div>
              </div>
          ...
          <div className="pt-4 border-t border-gray-100">
            ...
            <div className="flex justify-between items-center text-tech-blue font-black text-2xl pt-4 border-t border-gray-100">
              <span>Total</span>
          ...
          <form id="checkout-form" onSubmit={handleCheckout} className="bg-white p-8 rounded-3xl shadow-xl border border-gray-100 space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-gray-200 outline-none focus:ring-2 focus:ring-tech-blue transition-all"
                  />
                </div>
            ...
            <div className="border-t border-gray-100 pt-8">
              <h3 className="text-xl font-black mb-6 flex items-center gap-2">
                <CreditCard className="text-tech-blue" size={24} /> Payment Method <span className="text-red-500">*</span>
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <label className={`flex items-center gap-4 p-4 rounded-2xl border-2 transition-all cursor-pointer ${formData.paymentMethod === 'Bank Transfer' ? 'border-tech-blue bg-blue-50' : 'border-gray-100 hover:bg-gray-50'}`}>
                  <input
                    type="radio"
                    name="paymentMethod"
                    value="Bank Transfer"
                  ...
                  <div className="flex items-center gap-3">
                    <div className="bg-white p-2 rounded-lg text-tech-blue shadow-sm"><Banknote size={20} /></div>
                    <div>
                ...
                <label className={`flex items-center gap-4 p-4 rounded-2xl border-2 transition-all cursor-pointer ${formData.paymentMethod === 'Payment on Delivery' ? 'border-tech-blue bg-blue-50' : 'border-gray-100 hover:bg-gray-50'}`}>
                  <input
                    type="radio"
                    name="paymentMethod"
              ...
              {formData.paymentMethod === 'Bank Transfer' && (
                <div className="mt-8 p-6 bg-blue-50 rounded-2xl border border-blue-100 animate-in fade-in slide-in-from-top-4 duration-300">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="bg-tech-blue text-white p-2 rounded-lg"><ShieldCheck size={20} /></div>
                  ...
                  <div className="space-y-4">
                    <label className="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-tech-blue/30 rounded-2xl cursor-pointer hover:bg-white transition-colors">
                      <div className="flex flex-col items-center justify-center pt-5 pb-6">
                        <Camera size={24} className="text-tech-blue mb-2" />
                        <p className="text-xs text-tech-blue font-bold">
            ...
            <div className="pt-6">
              <button
                ...
                className={`w-full flex items-center justify-center gap-3 bg-tech-blue hover:bg-blue-900 text-white py-5 rounded-2xl font-black text-xl transition shadow-xl active:scale-[0.98] ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
              >
                <ShoppingBag size={24} />
