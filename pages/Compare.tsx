...
const Compare: React.FC = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 py-12 min-h-[70vh]">
            ...
            <Link to="/shop" className="flex items-center gap-2 text-gray-500 hover:text-tech-blue font-bold transition group mb-8">
                        ...
                        <div key={i} className={`relative rounded-3xl border-2 ${laptop ? 'border-gray-200 bg-white' : 'border-dashed border-gray-300 bg-gray-50'} p-6 flex flex-col items-center justify-center min-h-[200px] transition-all`}>
                            {laptop ? (
                                ...
                                <button
                                    ...
                                    className="flex flex-col items-center gap-3 text-gray-400 hover:text-tech-blue transition"
                                >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    {selectedLaptops.map(l => (
                        <button
                            key={l.id}
                            onClick={() => addToCart(l)}
                            className="flex items-center justify-center gap-2 bg-tech-blue text-white py-4 rounded-2xl font-black text-sm hover:bg-blue-900 transition active:scale-95 shadow-lg"
                        >
                            ...
                            {inventory
                                ...
                                .map(l => (
                                    <button
                                        ...
                                        className="w-full flex items-center gap-4 p-4 rounded-2xl border border-gray-100 hover:bg-blue-50 hover:border-tech-blue transition text-left"
                                    >
