...
const Login: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-950 via-tech-blue to-blue-700 flex items-center justify-center p-4">
            ...
            <div className="relative bg-white rounded-[2.5rem] shadow-2xl p-10 max-w-md w-full text-center">
                ...
                <div className="flex items-center justify-center gap-3 mb-8">
                    ...
                    <div className="text-left">
                        <p className="font-black text-2xl text-tech-blue leading-none">Info-Fix</p>
                ...
                {loading ? (
                    <div className="flex flex-col items-center gap-3 py-4">
                        <Loader size={32} className="text-tech-blue animate-spin" />
                        <p className="text-gray-400 text-xs font-bold uppercase tracking-widest">Signing you in...</p>
                    </div>
                ) : (
                    <button
                        onClick={handleGoogleSignIn}
                        className="w-full flex items-center justify-center gap-3 bg-white border-2 border-gray-200 text-gray-700 font-black py-4 rounded-2xl hover:border-tech-blue hover:bg-blue-50 transition-all shadow-sm hover:shadow-md active:scale-95 group"
                    >
                        {/* Google SVG Icon */}
                ...
                <p className="text-gray-400 text-[11px] mt-8 leading-relaxed">
                    By signing in, you agree to Info-Fix's terms of service.<br />
