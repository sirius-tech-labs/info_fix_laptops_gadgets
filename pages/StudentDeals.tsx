...
const StudentDeals: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12">
      <div className="bg-orange-500 rounded-3xl p-8 md:p-16 text-white mb-16 relative overflow-hidden">
        <div className="relative z-10 max-w-2xl">
          ...
          <p className="text-lg text-orange-50 opacity-90 mb-8">
      ...
      <div className="mt-20 bg-gray-50 border border-gray-100 rounded-3xl p-10 text-center">
        <h2 className="text-3xl font-black text-gray-900 mb-6">Join the Giant edge technology Community</h2>
        ...
        <div className="text-tech-blue font-black text-xl">We deliver laptops safely anywhere in Nigeria.</div>
      </div>
    </div>
  );
};
