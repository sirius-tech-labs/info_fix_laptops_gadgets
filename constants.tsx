...
export const TESTIMONIALS: Testimonial[] = [
  ...
  { id: '5', name: 'Femi Ogunlade', location: 'Ibadan', text: 'Third laptop I am buying from Giant edge technology. My whole family now uses their laptops. The student deals are unbeatable in Nigeria.', rating: 5 },
  ...
  { id: '7', name: 'Emeka Obi', location: 'Benin City', text: 'I compared prices across Computer Village and online. Giant edge technology gave me the best deal on the MacBook Pro. Genuine product, no stories.', rating: 5 },
