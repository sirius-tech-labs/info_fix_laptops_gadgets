...
export const getLaptopRecommendation = async (
  ...
  try {
    const response = await ai.models.generateContent({
      ...
      contents: `You are a friendly and knowledgeable laptop sales expert at Info-Fix Laptop Store in Nigeria.
...
- Always mention that Info-Fix offers nationwide delivery across Nigeria.
